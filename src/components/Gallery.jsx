...
const images = [
  { src:siteConfig.images.hero, alt:'Mountain lodge landscape', label:'The Highlands', span:'row-span-2' },
  { src:siteConfig.images.about, alt:'Luxury lodge exterior', label:'The Lodge' },
  { src:siteConfig.images.coffee, alt:'Coffee plantation', label:'Coffee Country' },
  { src:'https://images.pexels.com/photos/8082564/pexels-photo-8082564.jpeg?auto=compress&cs=tinysrgb&w=1600', alt:'Luxury hotel room', label:'Interiors', span:'row-span-2' },
  { src:siteConfig.images.terrace, alt:'Mountain terrace', label:'Around the lodge', span:'col-span-2' },
]
