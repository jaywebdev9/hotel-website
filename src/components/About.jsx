  ...
  <div className="max-w-7xl mx-auto px-6 md:px-10">
   <div className="grid lg:grid-cols-[.9fr_1.1fr] gap-14 lg:gap-20 items-center">
    ...
    <motion.div initial={{opacity:0,x:25}} whileInView={{opacity:1,x:0}} viewport={{once:true,amount:.25}} transition={{duration:.7,delay:.1}} className="relative min-h-[500px]">
      <img src="/images/lodge-view.webp" alt={t('Loleza Ridge lodge and highland view')} loading="lazy" decoding="async" className="feature-image absolute left-0 top-0 w-[76%] h-[430px] md:h-[520px] rounded-[1.6rem] object-cover"/>
      <img src="/images/room-suite.webp" alt={t('Loleza Ridge guest room')} loading="lazy" decoding="async" className="feature-image absolute right-0 bottom-0 w-[48%] h-[220px] md:h-[270px] rounded-[1.4rem] object-cover border-[10px] border-[#f8f5ee]"/>
    </motion.div>
   </div>
  </div>
 </section>
